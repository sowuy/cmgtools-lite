...
class ttHCoreEventAnalyzer( Analyzer ):
    def __init__(self, cfg_ana, cfg_comp, looperName ):
        ...
        self.leptonMVAKindTTH = getattr(self.cfg_ana, "leptonMVAKindTTH", "forMoriond17TTH")
        ...
        self.leptonMVAKindSUSY = getattr(self.cfg_ana, "leptonMVAKindSUSY", "forMoriond17SUSY")
